...
"""
Ejercicio 2:
    - Hacer nuestro propio Fringe para algoritmo branch and bound
"""
...
"""
Ejercicio 3:
    - Aplicar algoritmo branch and bound con heurística
"""


class branchAndBoundWithHeuristics(Queue):

    def __init__(self, gpsproblem):
        self.problem = gpsproblem
        self.A = []
        self.start = 0
    ...
    def extend(self, items):
        self.A.extend(items)  # path cost + heuristics
